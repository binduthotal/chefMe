...
const Home = () => {
  ...
  return (
    ...
    <main className="min-h-screen bg-[url('/kitchen-bg.jpg')] bg-cover bg-center bg-fixed text-[#1B211A] font-sans selection:bg-[#8BAE66] selection:text-white">
      {" "}
      {/* --- TOP HEADER --- */}
          ...
          <div className="flex h-16 sm:h-20 items-center justify-between gap-4 sm:gap-8">
            ...
            >
              <img
                src="/logo.svg"
                alt="Me Chef Logo"
                className="h-10 w-10 object-cover rounded-xl shadow-md shadow-[#628141]/20 transition-transform duration-300 group-hover:scale-105"
              />
              <span className="text-xl font-black tracking-tight text-[#1B211A]">
                Chef
              </span>
            </div>
            ...
            <div className="hidden md:flex items-center gap-3 shrink-0">
              <button
                ...
                className="cursor-pointer p-2 text-[#1B211A]/50 hover:text-[#1B211A] hover:bg-[#1B211A]/10 rounded-full transition"
                title="Logout"
              >
                <svg
                  className="h-5 w-5"
            ...
            <div className="md:hidden flex items-center">
              <button
                ...
                className="cursor-pointer p-2 text-[#1B211A] focus:outline-none"
              >
                <svg
                  className="w-7 h-7"
                  fill="none"
          ...
          <div className="md:hidden absolute top-16 right-4 w-56 bg-white/95 backdrop-blur-xl shadow-2xl rounded-2xl p-4 border border-[#EBD5AB]/50 flex flex-col gap-2 z-50">
            {menuItems.map((item) => (
              <button
                ...
                className={`cursor-pointer text-left px-4 py-3 rounded-xl text-sm font-bold transition-all ${
                  item === activeTab
                    ? "bg-[#628141] text-white"
                    : "text-[#1B211A]/80 hover:bg-[#EBD5AB]/40"
                }`}
              >
                {item}
              </button>
            ...
            <button
              onClick={handleLogout}
              className="cursor-pointer text-left px-4 py-3 text-sm font-bold text-red-600 hover:bg-red-50 rounded-xl transition"
            >
              Logout
            </button>
          </div>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 sm:py-10">
            ...
            {!isAddingRecipe ? (
              <div className="flex min-h-[400px] items-center justify-center rounded-[32px] border-2 border-dashed border-[#628141]/30 bg-white/50 p-8 backdrop-blur-sm">
                <div className="max-w-md text-center">
                  ...
                  <h3 className="mt-6 text-2xl font-bold text-[#1B211A]">
                    Add a New Recipe
                  </h3>
                  <p className="mt-3 text-[#1B211A]/70">
                    Your vault is ready. Start documenting your favorite dishes.
                  </p>
                  <button
              ...
              <div className="rounded-[32px] border border-white bg-white p-6 sm:p-10 shadow-xl shadow-[#628141]/5">
                <div className="flex justify-between items-center mb-8 border-b border-[#1B211A]/10 pb-6">
                  <h3 className="text-2xl font-black text-[#1B211A]">
                    New Recipe
                  </h3>
                  <button
                ...
                <form onSubmit={handleSaveRecipe} className="space-y-8">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <label className="block text-sm font-bold text-[#1B211A]/90 mb-2">
                        Recipe Title *
                      </label>
                      <input
                        required
                        ...
                        className="w-full rounded-xl border border-[#628141]/20 bg-[#EBD5AB]/20 px-4 py-3 text-[#1B211A] focus:border-[#628141] focus:ring-2 focus:ring-[#628141]/20 outline-none transition placeholder:text-[#1B211A]/40"
                      />
                    </div>
                    <div>
                      <label className="block text-sm font-bold text-[#1B211A]/90 mb-2">
                  ...
                  <div>
                    <label className="block text-sm font-bold text-[#1B211A]/90 mb-3">
                      Ingredients *
                    </label>
                    <div className="space-y-4">
                      {recipeData.ingredients.map((ingredient, index) => (
                        <div
                          key={index}
                          className="flex flex-col gap-4 p-5 rounded-2xl border border-[#628141]/20 bg-[#EBD5AB]/40"
                        >
                          <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                            {/* Ingredient Name - Takes full width on mobile, flexes on desktop */}
                            <input
                              required={index === 0}
                              type="text"
                              ...
                              className="w-full sm:flex-1 rounded-xl border border-[#628141]/20 bg-white px-4 py-2.5 text-[#1B211A] focus:border-[#628141] focus:ring-2 focus:ring-[#628141]/20 outline-none transition placeholder:text-[#1B211A]/40"
                            />

                            {/* Quantity & Delete Button - Grouped side-by-side */}
                            <div className="flex items-center gap-3 w-full sm:w-auto">
                              <input
                                ...
                                placeholder="Qty (1/2)"
                                className="flex-1 sm:w-28 rounded-xl border border-[#628141]/20 bg-white px-3 py-2.5 text-center text-[#1B211A] focus:border-[#628141] focus:ring-2 focus:ring-[#628141]/20 outline-none transition placeholder:text-[#1B211A]/40"
                              />
                              ...
                              {recipeData.ingredients.length > 1 && (
                                <button
                                  ...
                                  className="cursor-pointer p-2.5 text-[#1B211A]/40 hover:text-[#1B211A] hover:bg-[#1B211A]/10 rounded-xl transition shrink-0"
                    ...
                    <button
                      ...
                      className="cursor-pointer mt-4 inline-flex items-center gap-2 text-sm font-bold text-[#628141] hover:text-[#1B211A] transition"
                    >
                      <span className="flex h-5 w-5 items-center justify-center rounded-full bg-[#8BAE66]/30 text-[#628141] text-lg leading-none">
                        +
                      </span>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full rounded-xl border border-[#628141]/20 bg-[#EBD5AB]/20 px-4 py-3 text-[#1B211A] focus:border-[#628141] focus:ring-2 focus:ring-[#628141]/20 outline-none transition resize-none placeholder:text-[#1B211A]/40"
                    ></textarea>
                  </div>
                  ...
                  <div className="flex justify-end pt-6 border-t border-[#1B211A]/10">
                    <button
                      type="submit"
                      disabled={isSaving}
                      className={`cursor-pointer inline-flex items-center gap-2 rounded-xl px-8 py-3.5 text-sm font-bold text-white shadow-lg transition ${isSaving ? "bg-[#1B211A]/50 cursor-not-allowed" : "bg-[#628141] hover:bg-[#1B211A] hover:scale-[1.02] shadow-[#628141]/30"}`}
                    >
          ...
          <div className="animate-in fade-in duration-300">
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-6">
              <div>
                ...
                <h2 className="text-3xl font-black text-[#1B211A]">
                  All Recipes
                </h2>
              </div>
              <button
        ...
        {activeTab === "Favorites" && (
          <div className="animate-in fade-in duration-300">
            <div className="mb-6">
              <p className="text-sm font-bold uppercase tracking-widest text-[#8BAE66] mb-1">
                Your Best
              </p>
              <h2 className="text-3xl font-black text-[#1B211A]">
                Favorite Recipes
        ...
        {activeTab === "Shopping List" && (
          <div className="animate-in fade-in duration-300 flex flex-col items-center justify-center min-h-[400px] text-center bg-white/50 rounded-[32px] border border-white backdrop-blur-sm shadow-sm">
            ...
            <p className="text-[#1B211A]/70 mt-2">
